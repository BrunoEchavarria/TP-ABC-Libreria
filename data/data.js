...
},
{
    ...
    "image": "../img/HP4.jpg",
    "type": "fantasia",
    "informacion": "El Torneo de los Tres Magos se va a celebrar en Hogwarts. Solo los magos mayores de diecisiete años pueden participar, pero eso no impide a Harry fantasear con la posibilidad de ganar la competición. Tiempo después, en Halloween, el Cáliz de Fuego elige a los competidores y Harry se asombra al descubrir que su nombre está entre los elegidos por la copa mágica. Se enfrentará a tareas mortales, dragones y magos oscuros, pero con la ayuda de sus mejores amigos, Ron y Hermione, ¡puede que consiga salir vivo de esta!"
},
{
    "id": 5,
...
},
{
    ...
    "image": "../img/CS3.jpg",
    "type": "fantasia",
    "informacion": "Para salvar la vida de su madre, Clary debe viajar hasta la Ciudad de Cristal, el hogar ancestral de los cazadores de sombras. Por si fuera poco, Jace no quiere que vaya y Simon ha sido encarcelado por los propios Cazadores de Sombras, que no se fían de un vampiro resistente al sol. Mientras, Clary traba amistad con Sebastián, un misterioso cazador de sombras que se alía con ella."
},
{
    "id": 29,
    "name": "Ciudad de los Ángeles caídos",
    "image": "../img/CS4.jpg",
    "type": "fantasia",
    "informacion": "Alguien está dando muerte a los Cazadores de Sombras del círculo de Valentine, y esas muertes enemistan de nuevo a los Cazadores de Sombras con los subterráneos. Solo Simon, ahora convertido en vampiro, podrá evitar el enfrentamiento. Mientras, Clary y Jace descubrirán un misterio que les llevará a fortalecer su relación o... a destruirla para siempre."
},
{
    "id": 30,
    "name": "Ciudad de las Almas perdidas",
    "image": "../img/CS5.jpg",
    "type": "fantasia",
    "informacion": "Jace es ahora un sirviente del mal, vinculado a Sebastian por toda la eternidad. Solo un pequeño grupo de Cazadores de Sombras cree posible su salvación. Para lograrla, deben desafiar al Cónclave, y deben actuar sin Clary. Porque Clary está jugando a un juego muy peligroso por su propia cuenta y riesgo. Si pierde, el precio que deberá pagar no consiste tan solo en entregar su vida, sino también el alma de Jace. Clary está dispuesta a hacer lo que sea por Jace, pero ¿puede seguir confiando en él? ¿O lo ha perdido para siempre? ¿Es el precio a pagar demasiado alto, incluso para el amor?"
}
];